...
SRCS=shader.cpp controls.cpp context.cpp mesh.cpp ply.cpp
...
CXXFLAGS=$(LIBS) -lGLEW -lglfw3 -lX11 -lXxf86vm -pthread -lXrandr -lXinerama -lXi -lXcursor -lm -lGL -std=c++11 -g -lfreeimage
EXEC=$(EXEPATH)main
